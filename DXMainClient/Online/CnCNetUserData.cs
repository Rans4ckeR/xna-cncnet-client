...
public class CnCNetUserData
{
    ...
    /// <summary>
    /// Gets a list which contains names of players from recent games.
    /// </summary>
    ...
    private void LoadFriendList()
    {
        try
        {
            FileInfo friendListFile = new(ProgramConstants.GamePath + FRIEND_LIST_PATH);
    ...
    private void LoadIgnoreList()
    {
        try
        {
            FileInfo ignoreListFile = new(ProgramConstants.GamePath + IGNORE_LIST_PATH);
    ...
    private void LoadRecentPlayerList()
    {
        try
        {
            FileInfo recentListFile = new(ProgramConstants.GamePath + RECENT_LIST_PATH);
    ...
    private void SaveFriends()
    {
        ...
        try
        {
            ...
            File.WriteAllLines(
                ProgramConstants.GamePath + FRIEND_LIST_PATH,
                FriendList.ToArray());
        }
        catch (Exception ex)
        {
    ...
    private void SaveIgnoreList()
    {
        ...
        try
        {
            ...
            File.WriteAllLines(
                ProgramConstants.GamePath + IGNORE_LIST_PATH,
                IgnoreList.ToArray());
        }
        catch (Exception ex)
        {
