...
public class ChatMessage
{
    ...
    /// <param name="color">The color of the message.</param>
    /// <param name="message">The message.</param>
    public ChatMessage(string senderName, Color color, string message)
        : this(senderName, color, DateTime.Now, message)
    {
    }
    ...
    /// <param name="dateTime">The date and time of the message.</param>
    /// <param name="message">The message.</param>
    public ChatMessage(string senderName, string ident, bool senderIsAdmin, Color color, DateTime dateTime, string message)
        : this(senderName, color, dateTime, message)
    {
        SenderIdent = ident;
    ...
    public ChatMessage(Color color, string message)
        : this(null, color, DateTime.Now, message)
    {
    }
