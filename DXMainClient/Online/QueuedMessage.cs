...
public class QueuedMessage
{
    ...
    /// <summary>
    /// Gets or sets message Queue ID.
    /// </summary>
    public int ID { get; set; }

    /// <summary>
    /// Gets or sets the command to send to the IRC network.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the amount of milliseconds to delay the message.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether this can be used to replace a message on the queue to help prevent flooding purposes.
