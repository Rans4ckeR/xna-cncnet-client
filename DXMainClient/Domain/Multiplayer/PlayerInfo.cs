...
public class PlayerInfo
{
    ...
    /// <summary>
    /// Gets the "reversed" AI level ("how it was in Tiberian Sun UI") of the AI.
    ...
    /// <summary>
    /// Gets or sets the AI level of the AI for the [HouseHandicaps] section in spawn.ini.
    ...
    {
        ExtendedStringBuilder sb = new(true, ',');
        sb.Append(Name);
        sb.Append(SideId);
