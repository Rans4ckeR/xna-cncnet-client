...
internal static class PreStartup
{
    ...
    public static void Initialize(StartupParams parameters)
    {
        ...
        try
        {
            ...
            FileInfo iniFileInfo = new(ClientConfiguration.Instance.TranslationIniName);
        ...
        try
        {
            if (ClientConfiguration.Instance.GenerateTranslationStub)
            {
                ...
                TranslationTable stubTable = TranslationTable.Instance.Clone();
        ...
        {
            MessageBox.Show(
                "Deleting wsock32.dll failed! Please close any " +
    ...
    private static void HandleExcept(object sender, UnhandledExceptionEventArgs e)
    {
        ...
        try
        {
            if (!Directory.Exists(Environment.CurrentDirectory + "/Client/ClientCrashLogs"))
                _ = Directory.CreateDirectory(Environment.CurrentDirectory + "/Client/ClientCrashLogs");
