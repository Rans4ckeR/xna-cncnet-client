...
/// </summary>
internal class MainMenu : XNAWindow, ISwitchable
{
    ...
    public override void Initialize()
    {
        ...
        XNAClientButton btnExit = new(WindowManager);
        ...
        XNALabel lblCnCNetStatus = new(WindowManager);
    ...
    private void LblUpdateStatus_LeftClick(object sender, EventArgs e)
    {
        ...
        if (Updater.VersionState is VersionState.OUTDATED or
            VersionState.MISMATCHED or
            VersionState.UNKNOWN or
    ...
    private void Updater_OnCustomComponentsOutdated()
    {
        ...
        XNAMessageBox ccMsgBox = XNAMessageBox.ShowYesNoDialog(
            WindowManager,
    ...
    private void BtnMapEditor_LeftClick(object sender, EventArgs e) => MainMenu.LaunchMapEditor();
