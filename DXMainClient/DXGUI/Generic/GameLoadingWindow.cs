...
namespace DTAClient.DXGUI.Generic
{
    ...
    public class GameLoadingWindow : XNAWindow
    {
        ...
        private void BtnLaunch_LeftClick(object sender, EventArgs e)
        {
            ...
            using StreamWriter sw1 = new StreamWriter(spawnerSettingsFile.FullName);
            sw1.WriteLine("; generated by DTA Client");
            sw1.WriteLine("[Settings]");
            sw1.WriteLine("Scenario=spawnmap.ini");
            sw1.WriteLine("SaveGameName=" + sg.FileName);
            sw1.WriteLine("LoadSaveGame=Yes");
            sw1.WriteLine("SidebarHack=" + ClientConfiguration.Instance.SidebarHack);
            sw1.WriteLine("CustomLoadScreen=" + LoadingScreenController.GetLoadScreenName("g"));
            sw1.WriteLine("Firestorm=No");
            sw1.WriteLine("GameSpeed=" + UserINISettings.Instance.GameSpeed);
            sw1.WriteLine();

            FileInfo spawMapIniFile = SafePath.GetFile(ProgramConstants.GamePath, "spawnmap.ini");

            if (spawMapIniFile.Exists)
                spawMapIniFile.Delete();

            using StreamWriter sw2 = new StreamWriter(spawMapIniFile.FullName);
            sw2.WriteLine("[Map]");
            sw2.WriteLine("Size=0,0,50,50");
            sw2.WriteLine("LocalSize=0,0,50,50");
            sw2.WriteLine();
