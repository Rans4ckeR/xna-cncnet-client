    ...
    public class GameLoadingWindow : XNAWindow
    {
        ...
        private async ValueTask BtnLaunch_LeftClickAsync()
        {
...
#endif
            {
                ...
                await spawnStreamWriter.WriteLineAsync("SaveGameName=" + sg.FileName).ConfigureAwait(true);
                await spawnStreamWriter.WriteLineAsync("LoadSaveGame=Yes").ConfigureAwait(true);
                await spawnStreamWriter.WriteLineAsync("SidebarHack=" + ClientConfiguration.Instance.SidebarHack).ConfigureAwait(true);
                await spawnStreamWriter.WriteLineAsync("CustomLoadScreen=" + LoadingScreenController.GetLoadScreenName("g")).ConfigureAwait(true);
                await spawnStreamWriter.WriteLineAsync("Firestorm=No").ConfigureAwait(true);
