...
namespace DTAClient.DXGUI.Generic
{
    public class CampaignSelector : XNAWindow
    {
        ...
        private void LaunchMission(Mission mission)
        {
            ...
            using StreamWriter spawnStreamWriter = new StreamWriter(SafePath.CombineFilePath(ProgramConstants.GamePath, ProgramConstants.SPAWNER_SETTINGS));
            ...
            IniFile difficultyIni = new IniFile(SafePath.CombineFilePath(ProgramConstants.GamePath, DifficultyIniPaths[trbDifficultySelector.Value]));
            ...
            if (copyMapsToSpawnmapINI)
            {
                IniFile mapIni = new IniFile(SafePath.CombineFilePath(ProgramConstants.GamePath, mission.Scenario));
        ...
        private bool ParseBattleIni(string path)
        {
            ...
            IniFile battleIni = new IniFile(battleIniFileInfo.FullName);
