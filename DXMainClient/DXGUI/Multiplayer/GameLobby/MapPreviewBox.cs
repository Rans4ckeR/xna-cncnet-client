...
public class MapPreviewBox : XNAPanel
{
    ...
    public override void Initialize()
    {
        ...
        {
            ClientRectangle = new Rectangle(0, 0, 120, 2)
        };
        ...
        {
            IdleTexture = AssetLoader.LoadTexture("favInactive.png")
        };
        ...
        {
            IdleTexture = AssetLoader.LoadTexture("pvTexturesActive.png")
        };
    ...
    public void RefreshFavoriteBtn()
    {
        ...
        string textureName = isFav ? "favActive.png" : "favInactive.png";
        string hoverTextureName = isFav ? "favActive_c.png" : "favInactive_c.png";
    ...
    private void Indicator_LeftClick(object sender, EventArgs e)
    {
        ...
        PlayerLocationIndicator indicator = (PlayerLocationIndicator)sender;
    ...
    private void UpdateMap()
    {
        ...
        if (xRatio > yRatio)
        {
            ...
            texturePositionX = (Width - 2 - textureWidth) / 2;
        }
        else
        {
            ratio = xRatio;
