...
internal class CnCNetLobby : XNAWindow, ISwitchable
{
    ...
    private void SharedUILogic_GameProcessStarted()
    {
        connectionManager.SendCustomMessage(new QueuedMessage(
            ...
            QueuedMessageType.SYSTEMMESSAGE, 0));
    }
    ...
    private void _JoinGame(HostedCnCNetGame hg, string password)
    {
        ...
        connectionManager.SendCustomMessage(new QueuedMessage(
            ...
            QueuedMessageType.INSTANTMESSAGE, 0));
    }
    ...
    private void HandleGameInviteCommand(string sender, string argumentsString)
    {
            ...
            !cncnetUserData.IsFriend(sender)))
        {
            ...
            connectionManager.SendCustomMessage(new QueuedMessage(
                ...
                QueuedMessageType.CHATMESSAGE, 0));
    ...
    private void GameBroadcastChannel_CTCPReceived(object sender, ChannelCTCPEventArgs e)
    {
            ...
            e.Message.Length > 7)
        {
            ...
            {
                XNAMessageBox updateMessageBox = XNAMessageBox.ShowYesNoDialog(WindowManager, "Update available".L10N("UI:Main:UpdateAvailableTitle"),
        ...
        try
        {
            ...
            HostedCnCNetGame game = new(gameRoomChannelName, revision, gameVersion, maxPlayers,
