...
public class PrivateMessageNotificationBox : XNAPanel
{
    ...
    public override void Initialize()
    {
        ...
        XNALabel lblHeader = new(WindowManager)
        {
            Name = "lblHeader",
            FontIndex = 1,
            Text = "PRIVATE MESSAGE".L10N("UI:Main:PMHeader")
        };
        AddChild(lblHeader);
        ...
        XNALabel lblHint = new(WindowManager)
        {
            ...
            Text = "Press F4 to respond".L10N("UI:Main:F4ToRespond")
        };
        ...
        gameIconPanel = new XNAPanel(WindowManager)
        {
            ...
            DrawBorders = false,
            BackgroundTexture = AssetLoader.TextureFromImage(ClientCore.Properties.Resources.dtaicon)
        };
