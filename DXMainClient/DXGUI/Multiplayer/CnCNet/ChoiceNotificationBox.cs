...
public class ChoiceNotificationBox : XNAPanel
{
    ...
    public override void Initialize()
    {
        ...
        {
            ClientRectangle = new Rectangle(ClientRectangle.Left + 8, lblChoiceText.Bottom + 6, 75, 23)
        };
        ...
        {
            ClientRectangle = new Rectangle(ClientRectangle.Width - (75 + 8), lblChoiceText.Bottom + 6, 75, 23)
        };
