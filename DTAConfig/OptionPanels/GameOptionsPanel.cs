...
internal class GameOptionsPanel : XNAOptionsPanel
{
    ...
    public override void Initialize()
    {
        ...
        XNALabel lblScrollRate = new(WindowManager)
        {
            ...
            ClientRectangle = new Rectangle(
                ...
                0,
                0),
            Text = "Scroll Rate:".L10N("UI:DTAConfig:ScrollRate")
        };
        ...
        chkScrollCoasting = new SettingCheckBox(WindowManager, true, UserINISettings.OPTIONS, "ScrollMethod", true, "0", "1")
        {
            ...
            ClientRectangle = new Rectangle(
                lblScrollRate.X,
                trbScrollRate.Bottom + 20,
                0,
                0),
            Text = "Scroll Coasting".L10N("UI:DTAConfig:ScrollCoasting")
        };
        ...
        chkTargetLines = new SettingCheckBox(WindowManager, true, UserINISettings.OPTIONS, "UnitActionLines")
        {
            ...
            ClientRectangle = new Rectangle(
                lblScrollRate.X,
                chkScrollCoasting.Bottom + 24,
                0,
                0),
            Text = "Target Lines".L10N("UI:DTAConfig:TargetLines")
        };

        chkTooltips = new SettingCheckBox(WindowManager, true, UserINISettings.OPTIONS, "ToolTips")
        {
            Name = "chkTooltips",
            Text = "Tooltips".L10N("UI:DTAConfig:Tooltips")
        };

        XNALabel lblPlayerName = new(WindowManager)
        {
            Name = "lblPlayerName",
            Text = "Player Name*:".L10N("UI:DTAConfig:PlayerName")
        };

#if TS
        chkTooltips.ClientRectangle = new Rectangle(
            lblScrollRate.X,
            chkTargetLines.Bottom + 24,
            0,
            0);
#else
        chkShowHiddenObjects = new SettingCheckBox(WindowManager, true, UserINISettings.OPTIONS, "ShowHidden")
        {
            ...
            ClientRectangle = new Rectangle(
                ...
                0,
                0),
            Text = "Show Hidden Objects".L10N("UI:DTAConfig:YRShowHidden")
        };

        chkTooltips.ClientRectangle = new Rectangle(
            lblScrollRate.X,
            chkShowHiddenObjects.Bottom + 24,
            0,
            0);

        lblPlayerName.ClientRectangle = new Rectangle(
            lblScrollRate.X,
            chkTooltips.Bottom + 30,
            0,
            0);
        ...
        {
            Name = "chkBlackChatBackground",
            ClientRectangle = new Rectangle(
                chkScrollCoasting.X,
                chkTooltips.Bottom + 24,
                0,
                0),
            Text = "Use black background for in-game chat messages".L10N("UI:DTAConfig:TSUseBlackBackgroundChat")
        };
        ...
        {
            Name = "chkAltToUndeploy",
            ClientRectangle = new Rectangle(
                chkScrollCoasting.X,
                chkBlackChatBackground.Bottom + 24,
                0,
                0),
            Text = "Undeploy units by holding Alt key instead of a regular move command".L10N("UI:DTAConfig:TsUndeployAltKey")
        };
        ...
        XNAClientButton btnConfigureHotkeys = new(WindowManager)
        {
            ...
            ClientRectangle = new Rectangle(lblPlayerName.X, lblNotice.Bottom + 36, UIDesignConstants.ButtonWidth160, UIDesignConstants.ButtonHeight),
            Text = "Configure Hotkeys".L10N("UI:DTAConfig:ConfigureHotkeys")
        };
    ...
    public override void Load()
    {
        ...
        int scrollRate = GameOptionsPanel.ReverseScrollRate(IniSettings.ScrollRate);
    ...
    public override bool Save()
    {
        ...
        IniSettings.ScrollRate.Value = GameOptionsPanel.ReverseScrollRate(trbScrollRate.Value);
    ...
    private static int ReverseScrollRate(int scrollRate)
    {
