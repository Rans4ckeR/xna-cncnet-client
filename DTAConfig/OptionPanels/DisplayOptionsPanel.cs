...
internal partial class DisplayOptionsPanel : XNAOptionsPanel
{
    ...
    public override void Initialize()
    {
        ...
        XNALabel lblIngameResolution = new(WindowManager)
        {
            Name = "lblIngameResolution",
            ClientRectangle = new Rectangle(12, 14, 0, 0),
            Text = "In-game Resolution:".L10N("UI:DTAConfig:InGameResolution")
        };
        ...
        foreach (ScreenResolution res in resolutions)
            ddIngameResolution.AddItem(res.ToString());

        XNALabel lblDetailLevel = new(WindowManager)
        {
            Name = "lblDetailLevel",
            ClientRectangle = new Rectangle(
        ...
        XNALabel lblRenderer = new(WindowManager)
        {
            Name = "lblRenderer",
            ClientRectangle = new Rectangle(
                lblDetailLevel.X,
        ...
        OSVersion localOS = ClientConfiguration.GetOperatingSystemVersion();

        foreach (DirectDrawWrapper renderer in renderers)
        {
        ...
        ddClientResolution = new XNAClientPreferredItemDropDown(WindowManager)
        {
            ...
            ddIngameResolution.Height),
            AllowDropDown = false,
            PreferredItemLabel = "(recommended)".L10N("UI:DTAConfig:Recommended")
        };
        ...
        XNALabel lblClientTheme = new(WindowManager)
        {
            Name = "lblClientTheme",
            ClientRectangle = new Rectangle(
                lblClientResolution.X,
    ...
    public override bool Save()
    {
        ...
        {
            IniFile rendererSettingsIni = new(
