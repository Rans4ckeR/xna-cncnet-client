...
internal class ComponentsPanel : XNAOptionsPanel
{
    ...
    public void InstallComponent(int id)
    {
        ...
        cc.DownloadFinished += CustomComponent_DownloadFinished;
        cc.DownloadProgressChanged += CustomComponent_DownloadProgressChanged;
    ...
    private void Btn_LeftClick(object sender, EventArgs e)
    {
        ...
        else
        {
            XNAMessageBox msgBox = new(
                WindowManager,
                "Confirmation Required".L10N("UI:DTAConfig:UpdateConfirmRequiredTitle"),
                string.Format(
                    ...
                    GetSizeString(cc.Archived ? cc.RemoteArchiveSize : cc.RemoteSize)),
    ...
    private void CustomComponent_DownloadFinished(CustomComponent c, bool success)
    {
    ...
    private void CustomComponent_DownloadProgressChanged(CustomComponent c, int percentage)
    {
    ...
    private void HandleDownloadFinished(CustomComponent cc, bool success)
    {
        ...
        if (!success)
        {
            if (!downloadCancelled)
            {
                XNAMessageBox.Show(
                    WindowManager,
                    "Optional Component Download Failed".L10N("UI:DTAConfig:OptionalComponentDownloadFailedTitle"),
                    string.Format(
        ...
        else
        {
            XNAMessageBox.Show(
                WindowManager,
                "Download Completed".L10N("UI:DTAConfig:DownloadCompleteTitle"),
    ...
    private void Updater_FileIdentifiersUpdated() => UpdateInstallationButtons();
}