...
public class UserINISettings
{
    ...
    public const string GAMEFILTERS = "GameFilters";
    ...
    protected UserINISettings(IniFile iniFile)
    {
        ...
        SortState = new IntSetting(iniFile, GAMEFILTERS, "SortState", (int)SortDirection.None);
        ShowFriendGamesOnly = new BoolSetting(iniFile, GAMEFILTERS, "ShowFriendGamesOnly", DEFAULT_SHOW_FRIENDS_ONLY_GAMES);
        HideLockedGames = new BoolSetting(iniFile, GAMEFILTERS, "HideLockedGames", DEFAULT_HIDE_LOCKED_GAMES);
        HidePasswordedGames = new BoolSetting(iniFile, GAMEFILTERS, "HidePasswordedGames", DEFAULT_HIDE_PASSWORDED_GAMES);
        HideIncompatibleGames = new BoolSetting(iniFile, GAMEFILTERS, "HideIncompatibleGames", DEFAULT_HIDE_INCOMPATIBLE_GAMES);
        MaxPlayerCount = new IntRangeSetting(iniFile, GAMEFILTERS, "MaxPlayerCount", DEFAULT_MAX_PLAYER_COUNT, 2, 8);
    ...
    public bool ToggleFavoriteMap(string mapName, string gameModeName, bool isFavorite)
    {
        ...
        string favoriteMapKey = UserINISettings.FavoriteMapKey(mapName, gameModeName);
